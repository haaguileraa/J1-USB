...
\ memory map uart:
h# 6900 constant uart_data    \ escritura de datos que van a la uart
h# 6902 constant uart_busy    \ para lectura de uart (uart_busy)
h# 6904 constant uart_avail

\ memory map timer;
h# 7100 constant timer_enable
h# 7102 constant timer_match
h# 7104 constant timer_compare
h# 7106 constant timer_counter
